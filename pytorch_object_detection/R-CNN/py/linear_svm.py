...
if __name__ == '__main__':
    ...
    data_loaders, data_sizes = load_data('/data/fdiao/learning/deep-learning-for-image-processing-OD/pytorch_object_detection/R-CNN/data/classifier_car')

    # 加载CNN模型
    model_path = '/data/fdiao/learning/deep-learning-for-image-processing-OD/pytorch_object_detection/R-CNN/models/alexnet_car.pth'
    # 不使用预训练权重
    model = alexnet()
    num_classes = 2
